		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content">
		            ...
		            <div class="panel panel-white">
						<div class="panel-heading">
							<h6 class="panel-title">Saving wizard state</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
		            ...
		            <div class="panel panel-white">
						<div class="panel-heading">
							<h6 class="panel-title">Change starting step</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
		            ...
		            <div class="panel panel-white">
						<div class="panel-heading">
							<h6 class="panel-title">Remote content source</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
	                	...
	                	<form class="steps-async" action="#">
							<h6>Personal data</h6>
							<fieldset data-mode="async" data-url="assets/demo_data/wizard/personal_data.html"></fieldset>

							<h6>Your education</h6>
							<fieldset data-mode="async" data-url="assets/demo_data/wizard/education.html"></fieldset>

							<h6>Your experience</h6>
							<fieldset data-mode="async" data-url="assets/demo_data/wizard/experience.html"></fieldset>
