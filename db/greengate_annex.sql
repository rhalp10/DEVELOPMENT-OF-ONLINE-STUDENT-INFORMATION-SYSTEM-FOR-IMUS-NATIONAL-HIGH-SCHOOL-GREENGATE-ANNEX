...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2019 at 09:47 PM
...
(3, NULL, '31231233', 'Rhalp1', 'Darren', 'Cabrera', 1, 1, NULL, '123123', 'Blk 38 Lot 11 Phase2b Southville2 Trece Martires City', NULL);
...
(2, '3310222', 'dawe', 'd', 'caer', 1, 1, NULL, '09787', 'blk38 lot 11');
...
INSERT INTO `teacher_subject_assign` (`tsa_ID`, `rtd_ID`, `subject_ID`, `semester_ID`) VALUES
(1, 1, 1, 1),
(2, 2, 1, 1),
(7, 2, 2, 2);
...
(7, 4, NULL, '3310222', '6Bgzqn4mnCPjx432mpfOVbU87Mi3sy29KRe8A1l+2X0=', 'teacher@gmail.com', '2019-03-18 17:23:29', 1);
...
--
ALTER TABLE `record_parent_details`
  MODIFY `parent_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `teacher_subject_assign`
  MODIFY `tsa_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
