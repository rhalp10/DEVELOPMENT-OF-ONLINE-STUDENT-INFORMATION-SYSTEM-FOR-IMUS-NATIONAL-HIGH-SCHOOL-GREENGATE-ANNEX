      ...
      <form method="post" id="teacher_form" enctype="multipart/form-data">
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                  <img id="s_img" src="../assets/img/users/default.jpg" alt="teacher Image"  runat="server"  height="125" width="125" class="rounded-circle" style="border:1px solid; border-color: #4caf50;"/>
                  <br><br>
