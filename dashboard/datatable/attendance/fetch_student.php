...
foreach($result as $row)
{
  ...
  $sub_array[] = $row['sex_Name'];
    ...
    $sub_array[] = '<select name="stud_select_attnd[]" id="stud_select_attnd" class="form-control">
        <option value="">- SELECT - </option>
         <option value="P-'.$row["recs_ID"].'">Present</option>
        <option value="A-'.$row["recs_ID"].'">Absent</option>
</select>';
