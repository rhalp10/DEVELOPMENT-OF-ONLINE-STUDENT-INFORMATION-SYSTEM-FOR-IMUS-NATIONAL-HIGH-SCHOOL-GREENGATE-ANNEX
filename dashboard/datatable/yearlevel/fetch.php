...
foreach($result as $row)
{
	...
	$sub_array = array();
		...
		$sub_array[] = '
		<div class="btn-group">
		  <button class="btn btn-info btn-sm view"  id="'.$row["yl_ID"].'"><i class="icon-eye" style="font-size: 20px;"></i></button>
		  <button class="btn btn-primary btn-sm edit"  id="'.$row["yl_ID"].'"><i class="icon-database-edit2" style="font-size: 20px;"></i></button>
		</div>
		';
