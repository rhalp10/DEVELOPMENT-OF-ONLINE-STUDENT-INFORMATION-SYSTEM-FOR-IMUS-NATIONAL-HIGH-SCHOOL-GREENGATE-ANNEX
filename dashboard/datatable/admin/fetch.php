...
foreach($result as $row)
{
		...
		if(empty($row["user_ID"]))
	{
		...
		$acreg = "UN";
		// $btnrg = '<button class="btn btn-success btn-sm gen_account"  id="'.$row["rad_ID"].'">Generate Account <i class="icon-gear" style="font-size: 20px;"></i></button>';
		$btnrg = '<button type="button" class="btn btn-success btn-sm gen_account" data-toggle="tooltip" data-html="true" title="Generate Account" id="'.$row["rad_ID"].'">
