      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="row">
              ...
              <div class="col-3 col-sm-3">
                <div class="card ">
                  <div class="card-header text-center" style=" background-color: #4caf50;
    padding: 42px 0;">
                  </div>
                  <div class="card-body text-center"  >
                    <div style="margin-top: -64px;">
                      
                    <img id="p_img" src="<?php $auth_user->getUserPic();?>" alt="Profile Image"  runat="server"  height="125" width="125" class="rounded-circle" style="border:1px solid; border-color: #4caf50;"/>
                    </div>
